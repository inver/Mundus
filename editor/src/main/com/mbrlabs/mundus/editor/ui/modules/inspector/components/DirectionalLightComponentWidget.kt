 ...
 * @version 07-07-2017
 */
class DirectionalLightComponentWidget(dirLightComponent: DirectionalLightComponent) : ComponentWidget<DirectionalLightComponent>("Directional Light Component", dirLightComponent) {
    ...
    private val colorField: ColorPickerField = ColorPickerField()
    ...
    private fun setupUI() {
        ...
        dirWrapper.add<FloatFieldWithLabel>(dirX).padBottom(pad.toFloat())
        dirWrapper.add<FloatFieldWithLabel>(dirY).padBottom(pad.toFloat())
        dirWrapper.add<FloatFieldWithLabel>(dirZ).padBottom(pad.toFloat()).row()
