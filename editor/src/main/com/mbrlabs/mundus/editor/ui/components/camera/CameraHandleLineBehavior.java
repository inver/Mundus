...
import com.mbrlabs.mundus.editor.ui.components.handle.DirectionHandleComponent;

public class CameraHandleLineBehavior extends BaseCameraHandleBehavior {
    ...
    public void doAction(GameObject object) {
        ...
        DirectionHandleComponent component = (DirectionHandleComponent) handle.getComponents().get(0);
