...
public interface MeshPartBuilder {
    ...
    /**
     * Set the color used to tint the vertex color, defaults to white. Only applicable for {@link VertexAttributes.Usage#ColorPacked} or
     * {@link VertexAttributes.Usage#ColorUnpacked}.
     */
     ...
     * adding many triangles using {@link #triangle(int, int, int)} to avoid multiple backing array resizes. The actual
     ...
     * adding many rectangles using {@link #rect(int, int, int, int)} to avoid multiple backing array resizes.
     *
     ...
     * {@link #addMesh(float[], int[], int, int)} method instead.
     *
