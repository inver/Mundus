...
public class OldDefaultShader extends BaseShader {
    ...
    public OldDefaultShader(final Renderable renderable) {
        this(renderable, new Config());
    }

    public OldDefaultShader(final Renderable renderable, final Config config) {
        this(renderable, config, createPrefix(renderable, config));
    }

    public OldDefaultShader(final Renderable renderable, final Config config, final String prefix) {
    ...
    public OldDefaultShader(final Renderable renderable, final Config config, final ShaderProgram shaderProgram) {
    ...
    public boolean equals(Object obj) {
        return (obj instanceof OldDefaultShader) && equals((OldDefaultShader) obj);
    }

    public boolean equals(OldDefaultShader obj) {
        return (obj == this);
    }
