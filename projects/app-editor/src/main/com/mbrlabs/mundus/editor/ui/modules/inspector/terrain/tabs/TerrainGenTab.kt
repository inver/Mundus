...
import com.mbrlabs.mundus.editor.ui.modules.inspector.terrain.tabs.generation.HeightmapTab
import com.mbrlabs.mundus.editor.ui.modules.inspector.terrain.tabs.generation.PerlinNoiseTab
...
class TerrainGenTab(parent: TerrainComponentWidget) : Tab(false, false), TabbedPaneListener {
    ...
    val heightmapTab = HeightmapTab()
    val perlinNoiseTab = PerlinNoiseTab()
