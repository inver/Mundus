...
import com.mbrlabs.mundus.editor.ui.modules.inspector.terrain.tabs.TerrainGenTab;
import com.mbrlabs.mundus.editor.ui.modules.inspector.terrain.tabs.TerrainPaintTab;
import com.mbrlabs.mundus.editor.ui.modules.inspector.terrain.tabs.TerrainSettingsTab;
    ...
    public void initGenTab(TerrainComponentWidget parent, @NotNull TerrainGenTab genTab) {
        ...
        genTab.getHeightmapTab().getLoadHeightMapBtn().addListener(new ClickListener() {
            ...
            public void clicked(InputEvent event, float x, float y) {
                ...
                if (file != null && file.exists() && FileFormatUtils.isImage(file)) {
