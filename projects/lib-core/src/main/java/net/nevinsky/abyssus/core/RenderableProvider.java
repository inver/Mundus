...
public interface RenderableProvider {
    /**
     * Returns {@link Renderable} instances. Renderables are obtained from the provided {@link Pool} and added to the
     * provided array. The Renderables obtained using {@link Pool#obtain()} will later be put back into the pool, do not
     * store them internally. The resulting array can be rendered via a {@link ModelBatch}.
     *
