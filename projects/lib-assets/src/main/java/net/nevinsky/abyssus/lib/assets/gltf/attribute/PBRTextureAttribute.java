...
public class PBRTextureAttribute extends TextureAttribute {
    ...
    static {
        Mask |= MetallicRoughnessTexture | OcclusionTexture | BaseColorTexture | NormalTexture | EmissiveTexture |
                BRDFLUTTexture | TransmissionTexture | ThicknessTexture | SpecularFactorTexture | IridescenceTexture |
                IridescenceThicknessTexture | TransmissionSourceTexture | SpecularColorTexture;
    }
    ...
    public int compareTo(Attribute o) {
        ...
        if (o instanceof PBRTextureAttribute) {
            ...
            if (!MathUtils.isEqual(rotationUV, other.rotationUV)) {
                return rotationUV < other.rotationUV ? -1 : 1;
            }
        }
        return 0;
    }
