...
public class MeshTangentSpaceGenerator {
    ...
    public static void computeTangentSpace(Mesh mesh, Material material, boolean computeNormals,
    ...
    public static void computeTangentSpace(float[] vertices, int[] indices, VertexAttributes attributesGroup,
    ...
    //
    private static void computeTangents(float[] vertices, int[] indices, VertexAttributes attributesGroup,
                                        VertexAttribute normalMapUVs) {
        int posOffset = attributesGroup.getOffset(Usage.Position);
        int normalOffset = attributesGroup.getOffset(Usage.Normal);
