 ...
 * @version 06-10-2016
 */
public class OldAssetManager implements Disposable {

    private static final String TAG = OldAssetManager.class.getSimpleName();
     ...
     */
    public OldAssetManager(FileHandle assetsFolder) {
     ...
     */
    public void loadAssets(AssetManager.AssetLoadingListener listener, boolean isRuntime) throws AssetNotFoundException, MetaFileParseException {
