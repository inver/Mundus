...
import com.mbrlabs.mundus.commons.ac3d.core.*;
...
//        return res.build();
    ...
    private List<Ac3dSurface> parseSurfaces(BufferedReader br, int count) throws IOException {
        ...
        for (int i = 0; i < count; i++) {
            ...
            var vertices = new ArrayList<Pair<Integer, Vector2>>();
